...
interproject.configure(globals(), 'atelier etgen lino_book lino_patrols')
...
extlinks = {
    ...
    'checkin':
    ('http://code.google.com/p/lino-patrols/source/detail?r=%s', 'Checkin '),
    'srcref': ('http://code.google.com/p/lino-patrols/source/browse%s', ''),
